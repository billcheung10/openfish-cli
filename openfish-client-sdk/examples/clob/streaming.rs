...
//! ```
//!
//! For authenticated streaming, set the `OPENFISH_PRIVATE_KEY` environment variable:
//! ```sh
//! OPENFISH_PRIVATE_KEY=0x... RUST_LOG=info cargo run --example streaming --features tracing
//! ```
