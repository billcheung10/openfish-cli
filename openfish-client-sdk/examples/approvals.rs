...
//! Token approval example for Openfish CLOB trading.
//!
//! This example demonstrates how to set the required token allowances for trading on Openfish.
...
use openfish_client_sdk::{POLYGON, PRIVATE_KEY_VAR, contract_config};
