//! Client for the Openfish Gamma API.
//!
//! This module provides an HTTP client for interacting with the Openfish Gamma API,
//! which offers endpoints for querying events, markets, tags, series, comments, and more.
//!
//! # Example
//!
//! ```no_run
//! use openfish_client_sdk::gamma::{Client, types::request::EventsRequest};
//!
...
/// HTTP client for the Openfish Gamma API.
///
...
/// # API Base URL
///
/// The default API endpoint is `https://gamma-api.openfish.com`.
///
/// # Example
///
/// ```no_run
...
impl Default for Client {
    fn default() -> Self {
        Client::new("https://gamma-api.openfish.com")
...
impl Client {
    ...
    ///
    /// Returns information about sports categories available on Openfish,
    ...
    ///
    /// Markets are the core trading instruments on Openfish. Use filters to search
