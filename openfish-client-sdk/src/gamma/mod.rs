//! Openfish Gamma API client and types.
//!
//! **Feature flag:** `gamma` (required to use this module)
//!
//! This module provides a client for interacting with the Openfish Gamma API,
//! which offers HTTP endpoints for querying events, markets, tags, series,
//! comments, profiles, and search functionality.
//!
//! # Overview
//!
//! The Gamma API provides market and event metadata for Openfish. It is
