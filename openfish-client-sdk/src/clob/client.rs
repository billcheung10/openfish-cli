...
use crate::clob::types::questions as question_types;
...
const ORDER_NAME: Option<Cow<'static, str>> = Some(Cow::Borrowed("Openfish CTF Exchange"));
...
/// The main way for API users to interact with the Openfish CLOB.
///
...
/// ```rust,no_run
/// use openfish_client_sdk::Result;
...
pub struct Config {
    /// Whether the [`Client`] will use the server time provided by Openfish when creating auth
    /// headers. This adds another round trip to the requests.
    #[builder(default)]
    use_server_time: bool,
    /// Override for the geoblock API host. Defaults to `https://openfish.com`.
...
impl ClientInner<Unauthenticated> {
    ...
    pub async fn create_api_key_with_invitation<S: Signer>(
        &self,
        signer: &S,
        nonce: Option<u32>,
        invitation_code: &str,
        ...
        let request = self
            ...
            .request(Method::POST, format!("{}auth/api-key", self.host))
            .build()?;
        let mut headers = self.create_headers(signer, nonce).await?;
        headers.insert(
            "OPENFISH_INVITATION_CODE",
            HeaderValue::from_str(invitation_code)?,
        );
...
impl<S: State> Client<S> {
    ...
    ///
    /// ```no_run
    /// # use openfish_client_sdk::clob::{Client, Config, types::TickSize};
    /// # fn main() -> Result<(), Box<dyn std::error::Error>> {
    /// use openfish_client_sdk::types::U256;
    ///
    /// let client = Client::new("https://clob.openfish.com", Config::default())?;
    ...
    /// Checks if the current IP address is geoblocked from accessing Openfish.
    ///
    /// This method queries the Openfish geoblock endpoint to determine if access
    ...
    /// ```rust,no_run
    /// use openfish_client_sdk::clob::{Client, Config};
    /// use openfish_client_sdk::error::{Kind, Geoblock};
    ///
    /// #[tokio::main]
    /// async fn main() -> anyhow::Result<()> {
    ///     let client = Client::new("https://clob.openfish.com", Config::default())?;
    ...
    /// Lists question templates, optionally filtered by category or search term.
    pub async fn list_templates(
        &self,
        request: &question_types::ListTemplatesRequest,
    ) -> Result<question_types::ListTemplatesResponse> {
        let params = request.query_params(None);
        let request = self
            .client()
            .request(
                Method::GET,
                format!("{}questions/templates{params}", self.host()),
            )
            .build()?;
        crate::request(&self.inner.client, request, None).await
    }

    /// Retrieves a single question template by ID.
    pub async fn get_template(&self, id: &Uuid) -> Result<question_types::GetTemplateResponse> {
        let request = self
            .client()
            .request(
                Method::GET,
                format!("{}questions/templates/{id}", self.host()),
            )
            .build()?;
        crate::request(&self.inner.client, request, None).await
    }

    /// Retrieves a single question template by slug.
    pub async fn get_template_by_slug(
        &self,
        slug: &str,
    ) -> Result<question_types::GetTemplateResponse> {
        let request = self
            .client()
            .request(
                Method::GET,
                format!("{}questions/templates/slug/{slug}", self.host()),
            )
            .build()?;
        crate::request(&self.inner.client, request, None).await
    }

    /// Lists question clusters, optionally filtered by template ID or search term.
    pub async fn list_clusters(
        &self,
        request: &question_types::ListClustersRequest,
    ) -> Result<question_types::ListClustersResponse> {
        let params = request.query_params(None);
        let request = self
            .client()
            .request(
                Method::GET,
                format!("{}questions/clusters{params}", self.host()),
            )
            .build()?;
        crate::request(&self.inner.client, request, None).await
    }

    /// Retrieves a single question cluster by ID.
    pub async fn get_cluster(&self, id: &Uuid) -> Result<question_types::GetClusterResponse> {
        let request = self
            .client()
            .request(
                Method::GET,
                format!("{}questions/clusters/{id}", self.host()),
            )
            .build()?;
        crate::request(&self.inner.client, request, None).await
    }

    /// Retrieves related markets for a given condition ID.
    pub async fn related_markets(
        &self,
        condition_id: &str,
        req: &question_types::RelatedMarketsRequest,
    ) -> Result<question_types::RelatedMarketsResponse> {
        let params = req.query_params(None);
        let request = self
            .client()
            .request(
                Method::GET,
                format!(
                    "{}questions/markets/{condition_id}/related{params}",
                    self.host()
                ),
            )
            .build()?;
    ...
    /// Retrieves fee information for a market by condition ID.
    pub async fn market_fees(
        &self,
        condition_id: &str,
    ) -> Result<question_types::MarketFeesResponse> {
        let request = self
            .client()
            .request(
                Method::GET,
                format!("{}questions/markets/{condition_id}/fees", self.host()),
            )
            .build()?;
        crate::request(&self.inner.client, request, None).await
    }

    /// Lists question auctions, optionally filtered by cluster ID or status.
    pub async fn list_auctions(
        &self,
        req: &question_types::ListAuctionsRequest,
    ) -> Result<question_types::ListAuctionsResponse> {
        let params = req.query_params(None);
        let request = self
            .client()
            .request(
                Method::GET,
                format!("{}questions/auctions{params}", self.host()),
            )
            .build()?;
        crate::request(&self.inner.client, request, None).await
    }

    /// Retrieves a single auction by ID, including its bids.
    pub async fn get_auction(&self, id: &Uuid) -> Result<question_types::GetAuctionResponse> {
        let request = self
            .client()
            .request(
                Method::GET,
                format!("{}questions/auctions/{id}", self.host()),
            )
            .build()?;
        crate::request(&self.inner.client, request, None).await
    }

    /// Lists bonds for a specific agent address.
    pub async fn agent_bonds(
        &self,
        address: &str,
        req: &question_types::ListBondsRequest,
    ) -> Result<question_types::ListBondsResponse> {
        let params = req.query_params(None);
        let request = self
            .client()
            .request(
                Method::GET,
                format!("{}bonds/agent/{address}{params}", self.host()),
            )
            .build()?;
        crate::request(&self.inner.client, request, None).await
    }

    /// Retrieves bond details and audit log for a market by condition ID.
    pub async fn market_bond(
        &self,
        condition_id: &str,
    ) -> Result<question_types::GetMarketBondResponse> {
        let request = self
            .client()
            .request(
                Method::GET,
                format!("{}bonds/market/{condition_id}", self.host()),
            )
            .build()?;
        crate::request(&self.inner.client, request, None).await
    }

    /// Retrieves bond requirements for a cluster by cluster ID.
    pub async fn bond_requirement(
        &self,
        cluster_id: &Uuid,
    ) -> Result<question_types::BondRequirementResponse> {
        let request = self
            .client()
            .request(
                Method::GET,
                format!("{}bonds/cluster/{cluster_id}/requirement", self.host()),
            )
            .build()?;
        crate::request(&self.inner.client, request, None).await
    }
...
impl Client<Unauthenticated> {
    ...
    /// # Arguments
    ///
    /// * `host` - The CLOB API URL (e.g., <https://clob.openfish.com>)
    ...
    /// Creates a new set of [`Credentials`] using a required invitation code.
    pub async fn create_api_key_with_invitation<S: Signer>(
        &self,
        signer: &S,
        nonce: Option<u32>,
        ...
        self.inner
            .create_api_key_with_invitation(signer, nonce, invitation_code)
            .await
    }
...
impl<K: Kind> Client<Authenticated<K>> {
    ...
    /// Retrieves a compact account snapshot for generated agents.
    ///
    /// This is intended as a read-only credential smoke test and reporting primitive.
    ///
    /// # Errors
    ///
    /// Returns an error if the request fails.
    pub async fn agent_account_state(&self) -> Result<serde_json::Value> {
        let request = self
            .client()
            .request(
                Method::GET,
                format!(
                    "{}agent/account/state?signature_type={}",
                    self.host(),
                    self.inner.signature_type as u8
                ),
            )
            .build()?;
        let headers = self.create_headers(&request).await?;
    ...
    // ─── Questions: Create & Resolve (authenticated) ───

    /// Creates a new question within a cluster.
    pub async fn create_question(
        &self,
        req: &question_types::CreateQuestionRequest,
    ) -> Result<question_types::CreateQuestionResponse> {
        let request = self
            .client()
            .request(Method::POST, format!("{}questions/create", self.host()))
            .json(req)
            .build()?;
        let headers = self.create_headers(&request).await?;
        crate::request(&self.inner.client, request, Some(headers)).await
    ...
    /// Resolves a question by specifying the winning outcome.
    pub async fn resolve_question(
        &self,
        req: &question_types::ResolveQuestionRequest,
    ) -> Result<question_types::ResolveQuestionResponse> {
        let request = self
            .client()
            .request(Method::POST, format!("{}questions/resolve", self.host()))
            .json(req)
            .build()?;
        let headers = self.create_headers(&request).await?;
        crate::request(&self.inner.client, request, Some(headers)).await
    ...
    /// Proposes a new question, initiating an auction for creator rights.
    pub async fn propose_question(
        &self,
        req: &question_types::ProposeQuestionRequest,
    ) -> Result<question_types::ProposeQuestionResponse> {
        let request = self
            .client()
            .request(Method::POST, format!("{}questions/propose", self.host()))
            .json(req)
            .build()?;
        let headers = self.create_headers(&request).await?;
        crate::request(&self.inner.client, request, Some(headers)).await
    ...
    pub async fn auction_bid(
        &self,
        auction_id: &Uuid,
        req: &question_types::AuctionBidRequest,
    ) -> Result<question_types::AuctionBidResponse> {
        let request = self
            .client()
            .request(
                Method::POST,
                format!("{}questions/auctions/{auction_id}/bid", self.host()),
            )
            .json(req)
            .build()?;
        let headers = self.create_headers(&request).await?;
    ...
    /// Posts a bond for a market condition.
    pub async fn post_bond(
        &self,
        req: &question_types::PostBondRequest,
    ) -> Result<question_types::PostBondResponse> {
        let request = self
            .client()
            .request(Method::POST, format!("{}bonds/post", self.host()))
            .json(req)
            .build()?;
        let headers = self.create_headers(&request).await?;
        crate::request(&self.inner.client, request, Some(headers)).await
    ...
    /// Disputes a market resolution.
    pub async fn dispute_resolution(
        &self,
        req: &question_types::DisputeRequest,
    ) -> Result<question_types::DisputeResponse> {
        let request = self
            .client()
            .request(Method::POST, format!("{}resolution/dispute", self.host()))
            .json(req)
            .build()?;
        let headers = self.create_headers(&request).await?;
        crate::request(&self.inner.client, request, Some(headers)).await
