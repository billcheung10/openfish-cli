//! Openfish CLOB (Central Limit Order Book) API client and types.
//!
//! **Feature flag:** None (this is the core module, always available)
//!
//! This module provides the primary client for interacting with the Openfish CLOB API,
//! which handles all trading operations including order placement, cancellation, market
//! data queries, and account management.
//!
//! # Overview
//!
//! The CLOB API is the main trading interface for Openfish. It supports both
...
//! use openfish_client_sdk::clob::{Client, Config};
//! use openfish_client_sdk::clob::types::{Side, SignedOrder};
//! use openfish_client_sdk::types::{dec, Decimal, U256};
//!
//! # async fn example() -> Result<(), Box<dyn std::error::Error>> {
...
//! # API Base URL
//!
//! The default API endpoint is `https://clob.openfish.com`.
