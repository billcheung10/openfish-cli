//! Openfish Bridge API client and types.
//!
//! **Feature flag:** `bridge` (required to use this module)
//!
//! This module provides a client for interacting with the Openfish Bridge API,
//! which enables bridging assets from various chains (EVM, Solana, Bitcoin) to
//! USDC.e on Polygon for trading on Openfish.
//!
//! # Overview
//!
...
//! # API Base URL
//!
//! The default API endpoint is `https://bridge.openfish.com`.
