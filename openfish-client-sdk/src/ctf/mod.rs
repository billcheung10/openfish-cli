...
//! all Openfish outcomes as binary ERC1155 tokens on Polygon. Each market has two
...
//!
//! ```ignore
//! use openfish_client_sdk::ctf::{Client, types::*};
...
//! # Resources
//!
//! - [CTF Documentation](https://docs.openfish.com/developers/CTF/overview)
