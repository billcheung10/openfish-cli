...
pub struct SplitPositionRequest {
    /// The collateral token address (e.g., USDC)
    pub collateral_token: Address,
    /// Parent collection ID (typically zero for Openfish)
    #[builder(default)]
    pub parent_collection_id: B256,
...
impl SplitPositionRequest {
    ...
    ///
    /// ```no_run
    /// # use openfish_client_sdk::ctf::types::SplitPositionRequest;
...
impl RedeemPositionsRequest {
    ...
    ///
    /// ```no_run
    /// # use openfish_client_sdk::ctf::types::RedeemPositionsRequest;
    /// # use openfish_client_sdk::types::address;
    /// # use alloy::primitives::{B256, U256};
