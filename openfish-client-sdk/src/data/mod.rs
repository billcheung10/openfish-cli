//! Openfish Data API client and types.
//!
//! **Feature flag:** `data` (required to use this module)
//!
//! This module provides a client for interacting with the Openfish Data API,
...
//! # Overview
//!
//! The Data API is a read-only HTTP API that provides access to Openfish data.
