//! Client for the Openfish Data API.
//!
//! This module provides an HTTP client for interacting with the Openfish Data API,
...
//! use openfish_client_sdk::data::{Client, types::request::PositionsRequest};
//!
...
/// HTTP client for the Openfish Data API.
///
...
/// # API Base URL
///
/// The default API endpoint is `https://data-api.openfish.com`.
///
/// # Example
///
/// ```no_run
...
impl Default for Client {
    fn default() -> Self {
        Client::new("https://data-api.openfish.com")
...
impl Client {
    ...
    /// # Arguments
    ///
    /// * `host` - The base URL for the Data API (e.g., `https://data-api.openfish.com`).
    ///
    /// # Errors
    ///
    ...
    ///
    /// Builders are third-party applications that integrate with Openfish.
