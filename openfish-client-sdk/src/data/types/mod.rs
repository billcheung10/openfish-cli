...
///
/// Activities represent various operations that users can perform on the Openfish protocol.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize, strum_macros::Display)]
#[serde(rename_all = "UPPERCASE")]
#[strum(serialize_all = "UPPERCASE")]
#[non_exhaustive]
...
///
/// ```
/// use openfish_client_sdk::data::types::MarketFilter;
...
///
/// ```
/// use openfish_client_sdk::data::types::TradeFilter;
