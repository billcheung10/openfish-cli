//! Request types for the Openfish Data API.
//!
...
/// use openfish_client_sdk::data::{types::request::PositionsRequest, types::{PositionSortBy, SortDirection}};
///
...
/// ```
/// use openfish_client_sdk::types::address;
/// use openfish_client_sdk::data::{types::request::TradesRequest, types::{Side, TradeFilter}};
...
/// ```
/// use openfish_client_sdk::types::address;
/// use openfish_client_sdk::data::{types::request::ActivityRequest, types::ActivityType};
///
...
///
/// ```
/// use openfish_client_sdk::data::types::request::HoldersRequest;
/// use openfish_client_sdk::types::b256;
///
...
/// ```
/// use openfish_client_sdk::types::address;
/// use openfish_client_sdk::data::{types::request::ClosedPositionsRequest, types::ClosedPositionSortBy};
///
...
/// applications that integrate with Openfish. Returns one entry per builder
...
///
/// ```
/// use openfish_client_sdk::data::{types::request::BuilderLeaderboardRequest, types::TimePeriod};
///
...
///
/// ```
/// use openfish_client_sdk::data::{types::request::BuilderVolumeRequest, types::TimePeriod};
///
...
///
/// ```
/// use openfish_client_sdk::data::{types::request::TraderLeaderboardRequest, types::{LeaderboardCategory, TimePeriod, LeaderboardOrderBy}};
///
