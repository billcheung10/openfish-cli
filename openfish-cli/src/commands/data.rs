...
impl From<TimePeriod> for openfish_client_sdk::data::types::TimePeriod {
...
impl From<OrderBy> for openfish_client_sdk::data::types::LeaderboardOrderBy {
